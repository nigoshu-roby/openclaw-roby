...
export type RobyLocalFirstStatus = {
  ...
  scheduleWindow?: "fixed" | "day" | "night";
  scheduleWindowLabel?: string;
  scheduleLocalTime?: string;
  minutesProfile?: string;
  minutesBaseProfile?: string;
  minutesDayProfile?: string;
  minutesNightProfile?: string;
  minutesLocalPreprocessEnabled?: boolean;
  minutesLocalPreprocessModel?: string;
  gmailProfile?: string;
  gmailBaseProfile?: string;
  gmailDayProfile?: string;
  gmailNightProfile?: string;
