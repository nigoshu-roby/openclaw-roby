...
def apply_gmail_profile(env: Dict[str, str], now: Optional[datetime] = None) -> Tuple[str, Dict[str, str]]:
    ...
    if profile == "quality":
        overrides = {
            ...
            "GMAIL_TRIAGE_SEMANTIC_TRIAGE_MAX_PER_RUN": env.get("ROBY_ORCH_GMAIL_SEMANTIC_MAX_QUALITY", "24"),
        ...
        overrides = {
            ...
            "GMAIL_TRIAGE_SEMANTIC_TRIAGE_ENABLE": "1",
            "GMAIL_TRIAGE_SEMANTIC_TRIAGE_MODEL": quality_model or cloud_model or fast_model,
            "GMAIL_TRIAGE_SEMANTIC_TRIAGE_MAX_PER_RUN": env.get("ROBY_ORCH_GMAIL_SEMANTIC_MAX_HYBRID", "12"),
            "GMAIL_TRIAGE_LLM_ENABLE": "1",
            "GMAIL_TRIAGE_LLM_MODEL": quality_model or cloud_model or fast_model,
            "GMAIL_TRIAGE_TASK_LLM_MODEL": quality_model or cloud_model or fast_model,
        ...
        overrides = {
            ...
            "GMAIL_TRIAGE_SEMANTIC_TRIAGE_MAX_PER_RUN": env.get("ROBY_ORCH_GMAIL_SEMANTIC_MAX_FAST", "8"),
